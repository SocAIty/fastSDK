...
from fastsdk.definitions.base_response import BaseJobResponse, SocaityJobResponse, \
    RunpodJobResponse, JobProgress
from fastsdk.client.definitions.server_response.response_parser import ResponseParser
...
from fastsdk.client.definitions.server_job_status import ServerJobStatus
...
class EndPointRequest:
    ...
    def _deal_with_errors(self, async_job: AsyncJob) -> bool:
        ...
        if type(async_job.error) not in (HTTPStatusError, RemoteProtocolError):
