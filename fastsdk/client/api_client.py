...
from fastsdk.definitions import ServiceSpecification
from fastsdk.utils import normalize_name
from fastsdk.client.definitions.endpoint import EndPoint
from fastsdk.client.definitions.service_adress import (
    ServiceAddress, SocaityServiceAddress, ReplicateServiceAddress,
...
from fastsdk.client.req.request_handler import RequestHandler
from fastsdk.client.req.request_handler_replicate import RequestHandlerReplicate
from fastsdk.client.req.request_handler_runpod import RequestHandlerRunpod
from fastsdk.client.req.request_handler_socaity import RequestHandlerSocaity
...
class APIClient:
    ...
    def __del__(self):
        ...
        try:
            ...
            print(f"Error removing service from registry: {e}")
            pass
...
def create_request_handler(
    ...
    if isinstance(service_address, ReplicateServiceAddress):
        ...
        ep_req = {
            ServiceSpecification.SOCAITY: RequestHandlerSocaity,
            ServiceSpecification.FASTTASKAPI: RequestHandlerSocaity,
            ServiceSpecification.RUNPOD: RequestHandlerRunpod,
            ServiceSpecification.REPLICATE: RequestHandlerReplicate,
            ServiceSpecification.OTHER: RequestHandler
        }
        if st not in ep_req:
            st = ServiceSpecification.OTHER

        if st == ServiceSpecification.RUNPOD:  # needed in localhost deploy
...
def determine_service_type_from_api_spec(service_url: str) -> ServiceSpecification:
    """
    ...
    try:
        ...
        return ServiceSpecification.OTHER
    ...
    if "fast-task-api" in info and "runpod" in info:
        # socaity service
        return ServiceSpecification.RUNPOD
    # default else
    return ServiceSpecification.FASTTASKAPI
