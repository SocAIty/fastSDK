...
class RequestHandlerRunpod(RequestHandler):
    ...
    async def request(
        ...
        # Reparse method e.g. myservice/swap_img to myservice/run + body_params
        # if socaity endpoint, the method name will come as "path" parameter within the body_params
