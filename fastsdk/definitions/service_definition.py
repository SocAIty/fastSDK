...
class EndpointParameter(BaseModel):
    ...
    schema: Optional[Dict[str, Any]] = None  # contains something like minLength, maxLength, etc.
...
class ServiceDefinition(Meta):
    ...
    source_identifier: Optional[str] = None  # identifier of the source of the service definition
    service_address: Optional[str] = None  # address of the service